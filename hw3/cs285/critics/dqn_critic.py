...
class DQNCritic(BaseCritic):
    ...
    def _build(self, q_func):
        ...
        if self.double_q:
            ...
            online_q_tp1_values = q_func(self.obs_tp1_ph, self.ac_dim, scope='q_func', reuse=False)
            online_act_tp1 = tf.argmax(self.online_q_tp1_values, axis=1)
            q_tp1 = tf.reduce_sum(self.q_tp1_values * tf.one_hot(online_act_tp1, self.ac_dim), axis=1)
        else:
